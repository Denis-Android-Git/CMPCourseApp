...
fun ManageChatHeaderRow(
    ...
    Row(
        ...
        IconButton(onClick = onCloseClick) {
            Icon(
                imageVector = Icons.Default.Close, contentDescription = stringResource(Res.string.cancel),
...
@Preview
@Composable
fun ManageChatHeaderRowPreview() {
    MyTheme {
        ManageChatHeaderRow(title = "Title", onCloseClick = {})
    }
}